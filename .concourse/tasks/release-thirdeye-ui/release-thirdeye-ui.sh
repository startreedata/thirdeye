...
//repo.startreedata.io/artifactory/api/npm/startree-ui/:_password=${ARTIFACTORY_PASSWORD}
//repo.startreedata.io/artifactory/api/npm/startree-ui/:username=${ARTIFACTORY_USERNAME}
