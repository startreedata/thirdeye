...
./mnwv install -DskipTests

# If you are working on backend, You may skip the ui module
./mnwv install -pl '!thirdeye-ui'

# To Skip Integration tests
./mnwv install -pl '!thirdeye-integration-tests'
```
...
To add/update license headers to the files run `./mnwv license:format`
...
```
./mnwv -B -DskipTests -Darguments=-DskipTests release:clean initialize release:prepare release:perform -DdryRun=true
```
