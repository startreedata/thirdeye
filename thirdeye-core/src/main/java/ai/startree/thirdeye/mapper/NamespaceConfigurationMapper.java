...
public interface NamespaceConfigurationMapper {
  ...
  NamespaceConfigurationMapper INSTANCE = Mappers.getMapper(NamespaceConfigurationMapper.class);

  NamespaceConfigurationDTO toDto(NamespaceConfigurationApi api);

  NamespaceConfigurationApi toApi(NamespaceConfigurationDTO dto);
}
