...
/**
 * This anomaly labeler wrapper runs the anomaly labeler component to label anomalies generated by
 * detector based on the labeler implementation.
 */
public class AnomalyLabelerWrapper extends DetectionPipeline {
  ...
  private final String labelerName;
  private final Labeler labeler;
  private final String metricUrn;

  public AnomalyLabelerWrapper(DataProvider provider, AlertDTO config, long startTime,
      long endTime) {
    ...
    this.labelerName = DetectionUtils
        .getComponentKey(MapUtils.getString(config.getProperties(), PROP_LABELER));
