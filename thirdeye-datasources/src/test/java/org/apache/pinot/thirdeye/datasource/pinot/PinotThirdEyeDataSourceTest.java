...
public class PinotThirdEyeDataSourceTest {
  ...
  public void testInitializeCacheLoaderFromGivenClass() throws Exception {
    ...
    PinotResponseCacheLoader cacheLoaderInstance = PinotThirdEyeDataSource
        .getCacheLoaderInstance(properties);
    Assert.assertTrue(
        PinotControllerResponseCacheLoader.class.equals(cacheLoaderInstance.getClass()));
  }
