...
public class CSVThirdEyeDataSourceTest {
  ...
  public void beforeMethod() {
    ...
    sources.put("source", new DataFrame()
        ...
        .addSeries("browser", "chrome", "chrome", "chrome", "chrome", "chrome", "chrome", "chrome",
            "chrome", "safari"));
  ...
  public void testFromUrl() throws Exception {
    ...
    CSVThirdEyeDataSource dataSource = CSVThirdEyeDataSource
        .fromUrl(sources, Collections.emptyMap());
  ...
  public void testGetDatasets() throws Exception {
    Assert.assertEquals(new HashSet<>(dataSource.getDatasets()),
        new HashSet<>(Arrays.asList("source", "other")));
  }
  ...
  public void testExecuteGroupByTimeGranularityAndColumns() throws Exception {
    ...
    ThirdEyeResponse expectedResponse = new CSVThirdEyeResponse(
        ...
        new DataFrame()
            ...
            .addSeries("browser", "chrome", "chrome", "chrome", "chrome", "chrome", "chrome",
                "chrome", "safari")
