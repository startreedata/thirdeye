...
public class MockGrouperTest {
  ...
  public void beforeMethod() {
    ...
    aggregates
        .put(slice1, new DataFrame().addSeries(DataFrame.COL_TIME, slice1.getStartMillis()).addSeries(
    ...
    aggregates.put(slice3, new DataFrame().addSeries(DataFrame.COL_VALUE, 200).addSeries(
        DataFrame.COL_TIME, slice3.getStartMillis()).setIndex(DataFrame.COL_TIME));
    aggregates.put(baselineSlice3, new DataFrame().addSeries(DataFrame.COL_VALUE, 150).addSeries(
        DataFrame.COL_TIME, baselineSlice3.getStartMillis()).setIndex(DataFrame.COL_TIME));
