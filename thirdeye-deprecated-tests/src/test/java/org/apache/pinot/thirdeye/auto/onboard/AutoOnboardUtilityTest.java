...
public class AutoOnboardUtilityTest {
  ...
  public void testDataSourceToAutoOnboardMap() {
    ...
    Assert.assertEquals(dummyMDSource.getClassName(),
        "org.apache.pinot.thirdeye.auto.onboard.AutoOnboardDummyDataSource");
    ...
    MetadataSourceConfig anotherDummyMDSource = dsToOnboardsMap.get("PinotThirdEyeDataSource")
        .get(1).getMetadataSourceConfig();
    Assert.assertEquals(anotherDummyMDSource.getClassName(),
        "org.apache.pinot.thirdeye.auto.onboard.AutoOnboardAnotherDummyDataSource");
    ...
    MetadataSourceConfig anotherRandomMDSource = dsToOnboardsMap.get("CSVThirdEyeDataSource").get(0)
        .getMetadataSourceConfig();
    Assert.assertEquals(anotherRandomMDSource.getClassName(),
        "org.apache.pinot.thirdeye.auto.onboard.AutoOnboardAnotherRandomDataSource");
