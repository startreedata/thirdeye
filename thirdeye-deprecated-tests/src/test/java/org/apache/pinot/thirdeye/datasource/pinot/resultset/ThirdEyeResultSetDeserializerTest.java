...
public class ThirdEyeResultSetDeserializerTest {
  ...
  public void initObjectMapper() {
    SimpleModule module = new SimpleModule("ThirdEyeResultSetDeserializer",
  ...
  public void testDeserializeSelectResult() {
    ...
    ThirdEyeDataFrameResultSet expectedResultSet = new ThirdEyeDataFrameResultSet(metaData,
        dataFrame);

    final String jsonString =
        "{\"" + ThirdEyeResultSetSerializer.GROUP_COLUMN_NAMES_FIELD + "\":[],\""
