...
public class TestEmailUtils {
  ...
  public void testGetValidEmailAddresses() {
    ...
    Assert.assertTrue(
        EmailUtils.getValidEmailAddresses(emailAddresses).equals(emailAddressesExpected));
    Assert.assertTrue(
        EmailUtils.getValidEmailAddresses(emailAddresses + ",user").equals(emailAddressesExpected));
    Assert.assertTrue(EmailUtils.getValidEmailAddresses(emailAddresses + ",user1@host1.domain1")
        .equals(emailAddressesExpected));
    Assert.assertTrue(
        EmailUtils.getValidEmailAddresses(emailAddresses + ",, , user1@host1.domain1,  ")
            .equals(emailAddressesExpected));
  }
}
