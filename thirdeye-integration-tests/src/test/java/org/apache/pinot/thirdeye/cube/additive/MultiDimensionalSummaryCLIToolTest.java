...
public class MultiDimensionalSummaryCLIToolTest {
  ...
  public void testInitiateCostFunction()
    ...
    String paramString = String
        .format("{\"className\":\"%s\"}", BalancedCostFunction.class.getName());
  ...
  public void testSanitizeDimensions() {
    List<String> dims = Arrays
        .asList("environment", "page", "page" + MultiDimensionalSummaryCLITool.TOP_K_POSTFIX);
    ...
    List<String> expectedSanitizedDims = Arrays
        .asList("page" + MultiDimensionalSummaryCLITool.TOP_K_POSTFIX);
