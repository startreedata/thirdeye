...
public class AlphaBetaAnomalyFilter extends BaseAnomalyFilter {

  private final static Logger LOG = LoggerFactory.getLogger(AlphaBetaAnomalyFilter.class);
  ...
  public AlphaBetaAnomalyFilter() {

  }

  public AlphaBetaAnomalyFilter(double alpha, double beta, double threshold) {
    this.alpha = alpha;
    this.beta = beta;
