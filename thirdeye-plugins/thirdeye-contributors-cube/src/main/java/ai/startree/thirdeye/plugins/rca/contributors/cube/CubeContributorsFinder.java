...
import ai.startree.thirdeye.plugins.rca.contributors.cube.data.Cube;
import ai.startree.thirdeye.plugins.rca.contributors.cube.data.CubeFetcher;
import ai.startree.thirdeye.plugins.rca.contributors.cube.data.Dimensions;
import ai.startree.thirdeye.plugins.rca.contributors.cube.summary.Summary;
...
public class CubeContributorsFinder implements ContributorsFinder {

  private static final Logger LOG = LoggerFactory.getLogger(CubeContributorsFinder.class);

  private final CubeConfiguration cubeConfiguration;
  private final AggregationLoader aggregationLoader;

  public CubeContributorsFinder(final AggregationLoader aggregationLoader, final CubeConfiguration cubeConfiguration) {
  ...
  private class CubeAlgorithmRunner {
    ...
    public CubeAlgorithmRunner(final DatasetConfigDTO datasetConfigDTO,
        ...
        final Interval baselineInterval, final Dimensions dimensions, final List<Predicate> filters,
