...
public class ThirdEyePinotSqlClient {

  private static final Logger LOG = LoggerFactory.getLogger(ThirdEyePinotSqlClient.class);
  ...
  public ThirdEyePinotSqlClient(DataSourceMetaBean dataSourceMeta) {
    final PinotSqlThirdEyeDataSourceConfig config = createFromProperties(dataSourceMeta.getProperties());
