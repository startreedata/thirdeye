...
import org.apache.pinot.thirdeye.datasource.pinot.resultset.AbstractThirdEyeResultSet;
...
public class ThirdEyeDataFrameResultSet extends AbstractThirdEyeResultSet {
  ...
  /**
   * Constructs a {@link ThirdEyeDataFrameResultSet} from any SQL's {@link ResultSet}.
   *
   ...
   */
  public static ThirdEyeDataFrameResultSet fromSQLResultSet(ResultSet resultSet,
      String metric,
  ...
  public static ColumnType getColumnTypeFromJdbcResultSet(final ResultSet resultSet,
      final String columnName) {
    try {
      return ColumnType.jdbcTypeToColumnType(resultSet.getMetaData()
          .getColumnType(resultSet.findColumn(columnName)));
    } catch (SQLException e) {
