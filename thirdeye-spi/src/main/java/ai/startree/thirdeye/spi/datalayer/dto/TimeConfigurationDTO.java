...
public class TimeConfigurationDTO {
  ...
  public TimeConfigurationDTO setTimezone(final DateTimeZone timezone) {
  ...
  public TimeConfigurationDTO setMinimumOnboardingStartTime(final long minimumOnboardingStartTime) {
  ...
  public TimeConfigurationDTO setDateTimePattern(
