...
public class Stats {
  ...
  // fixme cyril rewrite these stats to account for 0 cases - see test of simple to contributors
  //  algo - also don't return double.Nan if possible + return positive;INF rather than nan
