...
public interface DataCompletenessConfigManager extends AbstractManager<DataCompletenessConfigDTO> {
  ...
  List<DataCompletenessConfigDTO> findAllByDatasetAndInTimeRange(String dataset, long startTime,
      long endTime);

  List<DataCompletenessConfigDTO> findAllByDatasetAndInTimeRangeAndStatus(String dataset,
      long startTime, long endTime, boolean dataComplete);
  ...
  List<DataCompletenessConfigDTO> findAllByDatasetAndInTimeRangeAndPercentCompleteGT(String dataset,
      long startTime,
