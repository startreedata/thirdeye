 ...
 * The classification is supposed to determine the issue type of the anomalies that are generated by
 * the main anomaly
 * function, which is specified by mainFunctionIdList. Moreover, this configuration provides a list
 * of auxiliary
 * anomaly function ids whose anomalies are used for determining the issue type during the
 * classification.
 */
public class ClassificationConfigBean extends AbstractBean {
   ...
   *
   * @param mainFunctionIdList the id list of the main functions whose anomalies' issue type
   *     will be determined.
   */
  ...
  /**
   * Returns the list of ids of auxiliary anomaly functions whose anomalies are used for determining
   * the issue type of
  ...
  /**
   * Sets the list of ids of auxiliary anomaly functions whose anomalies are used for determining
   * the issue type of
   * the anomalies from main anomaly function.
   *
   ...
   *
   * @param classifierConfig the configuration, which should be given by a map of strings to
   *     strings, of classifier.
   */
