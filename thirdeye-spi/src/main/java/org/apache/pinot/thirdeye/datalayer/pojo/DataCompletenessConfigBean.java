...
public class DataCompletenessConfigBean extends AbstractBean {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getId(), dc.getId()) && Objects.equals(dataset, dc.getDataset())
        ...
        && Objects.equals(countStar, dc.getCountStar()) && Objects
        .equals(dataComplete, dc.isDataComplete())
        && Objects.equals(percentComplete, dc.getPercentComplete()) && Objects
        .equals(numAttempts, dc.getNumAttempts())
        && Objects.equals(delayNotified, dc.isDelayNotified()) && Objects
        .equals(timedOut, dc.isTimedOut());
  }

  @Override
  public int hashCode() {
    return Objects
        .hash(getId(), dataset, dateToCheckInMS, dateToCheckInSDF, countStar, dataComplete,
            percentComplete,
