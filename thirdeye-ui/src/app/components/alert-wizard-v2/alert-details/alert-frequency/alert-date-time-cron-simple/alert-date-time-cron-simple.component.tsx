...
export const AlertDateTimeCronSimple: FunctionComponent<AlertDateTimeCronSimpleProps> =
    ({ value, onChange }: AlertDateTimeCronSimpleProps) => {
        ...
        const handleHourChange = (newHour: number): void => {
            ...
            onChange(
                buildCronString({ minute, hour: normalizedHour, dayOfWeek })
            );
        };
