...
import { Accordion, AccordionDetails, AccordionSummary } from '../styles/accordian.style';
...
const FilterDropdownComponent = ({
    ...
    return <Accordion expanded={expanded} onChange={(): void => {return setExpanded(!expanded)}}>
                <AccordionSummary
                ...
                <AccordionDetails>
                    ...
                    <Autocomplete 
                        fullWidth
                        getOptionLabel={(option): string => {return option[labelProp] + ''}}
                        getOptionSelected={(option, value): boolean => {return option[valueProp] === value[valueProp]}}
                        loading={loading}
                        options={list || []}
                        renderInput={(params): ReactElement => {return (
                            <TextField
                                {...params}
                                InputProps={{
                                    ...params.InputProps,
                                ...
                                variant="outlined"
                                onChange={(e): void => {return setSearch(e.target.value)}}
                            />
                        )}}
                        size="small"
                    />
