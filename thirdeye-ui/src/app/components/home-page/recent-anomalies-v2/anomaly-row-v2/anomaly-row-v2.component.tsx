...
import { AnomalyRowProps } from "./anomaly-row-v2.interfaces";
import { useAnomaliesRowStyles } from "./anomaly-row-v2.styles";

export const AnomalyRowV2: FunctionComponent<AnomalyRowProps> = ({
    anomaly,
}) => {
        ...
        <TableBody innerRef={ref}>
            <TableRow className={isOpen ? classes.noBorder : undefined}>
                ...
                <TableCell>
                    ...
                    >
                        {isOpen ? t("label.hide-preview") : t("label.view")}
                    </Button>
                </TableCell>
            </TableRow>
