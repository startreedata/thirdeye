...
export const SubscriptionGroupWizard: FunctionComponent<SubscriptionGroupWizardProps> =
    ({ subscriptionGroup, alerts, onCancel, submitBtnLabel, onFinish }) => {
        ...
        const [isSubscriptionGroupValid, setIsSubscriptionGroupValid] =
            useState(validateSubscriptionGroup(subscriptionGroup));
            ...
            setEditedSubscriptionGroup(
                (newSubscriptionGroup): SubscriptionGroup => {
                    if (newSubscriptionGroup.notificationSchemes.email) {
                        ...
                        newSubscriptionGroup.notificationSchemes.email.to =
                            emails;
                    } else {
