...
export const TimeRangeSelectorPopoverContent: FunctionComponent<TimeRangeSelectorPopoverProps> =
    ({
        ...
        const [componentStartTime, setComponentStartTime] =
            useState<number>(start);
        const [componentEndTime, setComponentEndTime] = useState<number>(end);
        const timeRangeSelectorPopoverClasses =
            useTimeRangeSelectorPopoverStyles();
        ...
        const handleApplyClick = (): void => {
            ...
            props.onChange &&
                props.onChange(componentStartTime, componentEndTime);
            handleCancel();
        };
