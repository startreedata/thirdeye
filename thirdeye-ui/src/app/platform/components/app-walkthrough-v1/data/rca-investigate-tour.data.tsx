...
>(
    ({ handleChangeTab, setCurrentStep }) =>
        [
            {
                ...
                content: getContentElement({
                    ...
                    body: (
                        <ul>
                            <li>
                                Baseline Offset lets you view the impact profile
                                of each dimension across time
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                spike and a gentle slope on a granular level,
                                which may elude to the factors that caused the
            ...
            },
            {
                ...
                content: getContentElement({
                    ...
                    body: (
                        <>
                            <p>
                                This is a breakdown of the possible values for
                                each dimension, sized in proportion to
                                prevalence. Hovering over each value displays a
                                tooltip with more information about the absolute
                                value and the percentage change.
                            </p>
                            <Card elevation={0} variant="outlined">
                                <CardContent>
                                    Click on a dimensional value to apply it as
                                    a filter. The dimension heatmap will refresh
                                    according to the selected filter.
                                </CardContent>
                            </Card>
                            <p>
                                To add the selected value filter to the chart
                                above, click on &nbsp;
                                <Chip
                                    color="primary"
                                    label="Add to Chart"
...

            {
                ...
                content: getContentElement({
                    ...
                    body: (
                        <>
                            This tab shows the list of identified dimension (or
                            a group of dimensions) that have the most
                            contribution to the metrics trend change for a given
                            anomaly, ordered from highest impact to lowest
                            impact.
                        </>
                    ),
                }),
            ...
            },
            {
                ...
                content: getContentElement({
                    ...
                    body: (
                        <>
                            <p>
                                Events are specially designated intervals of
                                time where a general abnormal level of activity
                                is expected, like a holiday or a major
                                happening. This tab lets you see if a certain
                                anomaly is correlated with an event, which may
                            ...
                            <Card elevation={0} variant="outlined">
                                <CardContent>
                                    ...
                                    configuration for a campaign, adding that
                                    time period as an event to the investigation
                                    might help explain an abnormal frequency of
                                    observed anomalies that were unknowingly
                                    being caused by that change.
                                </CardContent>
                            </Card>
                            <p>
            ...
            },
            {
                ...
                content: getContentElement({
                    ...
                    body: (
                        <>
                            Finally, the investigation can be saved from the
                            button here. This will log the progress so far as an
                            investigation entry in the anomaly page as shown
                            previously, and be available for anyone to examine
                            in the future
                        </>
                    ),
                }),
