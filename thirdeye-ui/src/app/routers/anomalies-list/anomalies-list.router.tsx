...
const AnomaliesAllPage = lazy(() =>
    import(
        /* webpackChunkName: "anomalies-all-page" */ "../../pages/anomalies-list-all-page/anomalies-list-all-page.component"
    ).then((module) => ({ default: module.AnomaliesListAllPage }))
);
...
const AnomaliesViewIndexPage = lazy(() =>
    import(
        /* webpackChunkName: "anomalies-view-index-page" */ "../../pages/anomalies-view-index-page/anomalies-view-index-page.component"
...
export const AnomaliesListRouter: FunctionComponent = () => {
    return (
