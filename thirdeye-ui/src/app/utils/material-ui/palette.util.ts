...
const COLOR_WARNING_LIGHT = Color.YELLOW_1;
...
export const Palette = {
    ...
    // Visualizations
    COLOR_VISUALIZATION_STROKE_CURRENT: Color.BLUE_2,
    COLOR_VISUALIZATION_STROKE_BASELINE: Color.GREEN_7,
    COLOR_VISUALIZATION_STROKE_UPPER_AND_LOWER_BOUND: COLOR_WARNING_LIGHT,
