...
describe("alert duplicate flows", () => {
    beforeEach(() => {
    ...
    it("user can duplicate alert from the json editor flow", () => {
        ...
        cy.get(".CodeMirror")
            ...
            .then((editor) => {
                ...
                alertConfig.name = `${alertConfig.name}-copy`;
    ...
    it("user can duplicate from advanced flow", () => {
        cy.getByDataTestId(TEST_IDS.TABLE).find(CHECKBOX_SELECTOR).click();
        cy.getByDataTestId(TEST_IDS.DUPLICATE_BUTTON).click();
        cy.getByDataTestId(
    ...
    it("user can duplicate from simple mode", () => {
        cy.getByDataTestId(TEST_IDS.TABLE).find(CHECKBOX_SELECTOR).click();
        cy.getByDataTestId(TEST_IDS.DUPLICATE_BUTTON).click();
        cy.getByDataTestId(
            ALERT_CREATION_NAVIGATE_DROPDOWN_TEST_IDS.DROPDOWN_CONTAINER
